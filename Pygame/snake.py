...
def draw_game_over():
    ...
    pygame.draw.rect(screen, red, (screen_width // 2 - 80,
                     screen_height // 2 - 60, 160, 50))
...
while run:
    ...
    for x in snake_pos:
      ...
      if head == 0:
            pygame.draw.rect(screen, body_outer,
                           (x[0], x[1], cell_size, cell_size))
            pygame.draw.rect(screen, body_inner,
                           (x[0] + 1, x[1] + 1, cell_size - 2, cell_size - 2))
      if head == 1:
            pygame.draw.rect(screen, body_outer,
                             (x[0], x[1], cell_size, cell_size))
